...
const muscleClick=(e,mGroup)=>{
    ...
    e.setAttribute("fill", "#6ffacc")
    setMusclesList(mGroup)
...
return (
<svg   viewBox="0 0 500 320" preserveAspectRatio="xMidYMid meet" aria-labelledby="title" aria-describedby="desc" role="img" xmlns="http://www.w3.org/2000/svg">       
<title id="title">Muscle groups</title>
<desc id="desc">A stylized human figure displaying the big muscle groups</desc>
<g id="front" fill="#999999">
    <g fill="#999999" id="headneck">
    ...
    <g  fill="#999999" id="Quadriceps" className="figure" onClick={(e) => muscleClick(e.currentTarget,'Quadriceps')}>
    ...
    <g  fill="#999999" id="Chest" className="figure" onClick={(e) => muscleClick(e.currentTarget,'Chest')}>
    ...
    <g fill="#999999" id="Abdominals" className="figure" onClick={(e) => muscleClick(e.currentTarget,'Abdominals')}>
    ...
    <g fill="#999999" id="Biceps" className="figure" onClick={(e) => muscleClick(e.currentTarget,'Biceps')}>
    ...
    <g fill="#999999" id="Tibialis-anterior" className="figure" onClick={(e) => muscleClick(e.currentTarget,'Tibialis-anterioreps')}>
    ...
    <g fill="#999999" id="Deltoid" className="figure" onClick={(e) => muscleClick(e.currentTarget,'Deltoid')}>
    ...
    <g fill="#999999" id="Side-abs" className="figure" onClick={(e) => muscleClick(e.currentTarget,'Side-abs')}>
    ...
    <g fill="#999999" id="Forearms" className="figure" onClick={(e) => muscleClick(e.currentTarget,'Forearms')}>
...
<g id="Back">
    <g id="headback" fill="#999">
        ...
        <path d="m312.2 55c-3.9-2.6-8.6-2.9-11.5-.8-4.8 3.7-6.8 13.4-3.5 18.5 5.1-5.9 10-11.9 15-17.7z" 
            className="sholderBack"/>
        <path d="m361.1 55c5.1 6 10 11.9 15 17.7.3-.1.7-.2 1-.3.1-2.9.7-6 .3-8.9-1.1-9.8-8.6-13.4-16.3-8.5z"
            className="sholderBack" />
        </g>

    <g id="upperback" fill="#E4BB00" className="figure" onClick={(e) => muscleClick(e.currentTarget,'upperback')}>
    ...
    <g id="latissimus-dorsi" fill="#66A85E" className="figure" onClick={(e) => muscleClick(e.currentTarget,'latissimus-dorsi')}>
    ...
    <g id="Gluteus-maximus" fill="#40A1C1" className="figure" onClick={(e) => muscleClick(e.currentTarget,'Gluteus-maximus')}>
        ...
        fill="#999" className="balle" />
        <path d="m338.4 150.6c3.1-5 4.9-10.2 4.9-16-4.4 1.6-6.1 4.5-5.5 8.7.4 2.4.4 4.7.6 7.3z" 
        fill="#999" className="balle" />
    </g>


<g id="Hamstring" fill="#8F5EFF"  className="figure" onClick={(e) => muscleClick(e.currentTarget,'Hamstring')}>
    ...
    <g id="calf" fill="#0BD6B4"  className="figure" onClick={(e) => muscleClick(e.currentTarget,'calf')}>
